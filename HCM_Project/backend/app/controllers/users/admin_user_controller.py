...
from app.schemas.users.admin_user_schema import AdminUserCreate, AdminUserRead, AdminUserUpdate
...
def create_user(
    ...
    audit_service.record(
        ...
        detail={"username": user.username, "roles": user.roles, "auth_type": user.auth_type},
        request=request,
    )
