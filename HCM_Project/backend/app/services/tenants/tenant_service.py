...
``app.repositories.tenants.tenant_repository``."""
...
from app.models.tenants.tenant_model import LoginType, Tenant, TenantStatus
from app.repositories.tenants import tenant_repository as repo
